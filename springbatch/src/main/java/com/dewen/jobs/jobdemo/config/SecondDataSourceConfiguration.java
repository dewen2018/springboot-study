...
//
// @Configuration
// @MapperScan(value="com.dewen.jobs.jobdemo.model.dao.second", sqlSessionFactoryRef="secondSqlSessionFactory")
...
// 		sqlSessionFactoryBean.setTypeAliasesPackage("com.dewen.jobs.jobdemo.model.vo");
