...
import com.dewen.jobs.MySimpleJob;
...
public class MyJobConfig {
    ...
    private LiteJobConfiguration getLiteJobConfiguration(final Class<? extends SimpleJob> jobClass,
        ...
        // 定义Dataflow类型配置:false 非流式处理数据: 只会在每次作业执行过程中执行一次fetchData方法和processData方法，随即完成本次作业
        //DataflowJobConfiguration jobConfiguration = new DataflowJobConfiguration(simpleCoreConfig, jobClass.getCanonicalName(), false);
        // 定义Lite作业根配置
